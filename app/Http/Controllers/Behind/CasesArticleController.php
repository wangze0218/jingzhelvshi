...
use App\Business\CasesArticleBusiness as ArticleBusiness;
use App\ResponseTrait;

class CasesArticleController
{
    use ResponseTrait;
    ...
    public function index(Request $request)
    {
        ...
        return view('behind.cases_article.index',['list'=>$list,'page_num'=>$page_num,'search'=>$where,'article_all_type'=>$article_all_type]);
    }

    public function create(Request $request)
    {
        $article_all_type = $this->articleBusiness->article_all_type();
        return view('behind.cases_article.create',['article_all_type'=>$article_all_type]);
    }
    ...
    public function edit($id)
    {
        ...
        $article_all_type = $this->articleBusiness->article_all_type();
        return view('behind.cases_article.edit',['article'=>$article,'article_all_type'=>$article_all_type]);
    }
