...
@section('content')
    <div class="col-lg-12">
        <section class="form-group">
                <a type="button" onclick="return addOrEdit('/behind/team_article/create','团队人员添加',['1200px','600px']);"  class="btn btn-primary">添加团队人员</a>
        </section>
        ...
        <section class="panel">
            <div class="select row col-sm-12 panel-heading">
                ...
                <form action="/behind/team_article" method="get">
                    ...
                    <div class="col-md-2 pull-right">
                        <select class="colorpicker-default form-control" name="rel_type_id" id="">
                            @foreach($article_all_type as $k=>$v)
                                <option @if($search['rel_type_id'] == $v['team_id']) selected @endif value="{{$v['team_id']}}">{{$v['team_name']}}</option>
                            @endforeach
                        </select>
                    </div>
            ...
            <table class="table table-striped table-advance table-hover">
                ...
                <tr>
                    ...
                    <th class="hidden-phone"><i class="icon-question-sign"></i> 团队人员标题</th>
                    <th><i class=" icon-tasks"></i> 团队人员标题图片</th>
                    <th><i class=" icon-edit"></i> 团队人员标题详情</th>
