        ...
        <div class="col-md-12">
            <section class="panel">
                <div class="panel-body">
                    <form action="/behind/cases_article" role="form" id="from" method = 'post' onsubmit="return add('/behind/cases_article/');" enctype="multipart/form-data" class="form-horizontal tasi-form">
                            ...
                            <div class="col-md-4">
                                <select class="colorpicker-default form-control" name="rel_type_id" id="">
                                    @foreach($article_all_type as $k=>$v)
                                        <option value="{{$v['cases_id']}}">{{$v['cases_name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="title" class="colorpicker-default form-control" placeholder="请输入标题">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="vice_title_describe" id="" cols="50" rows="4"></textarea>
                            </div>
                        </div>
